...
namespace BudgetToSave.Controllers
{
    public class DonationTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DonationTypeID,Description")] DonationType donationType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DonationTypeID,Description")] DonationType donationType)
        {
            if (ModelState.IsValid)
            {
